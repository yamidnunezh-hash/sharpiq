...
def enviar_canal_free(partido, liga, hora):
    ...
    texto = (
        ...
        f"Únete al canal VIP → https://www.mercadopago.com.co/subscriptions/checkout?preapproval_plan_id=79abf20272b64347b16a901055c89d8c\n\n"
...
def enviar_resultado_free(partido, resultado_texto, emoji_resultado):
    ...
    texto = (
        ...
        f"{comentario}\n\n"
        f"🔒 Ver predicciones de mañana → https://www.mercadopago.com.co/subscriptions/checkout?preapproval_plan_id=79abf20272b64347b16a901055c89d8c\n"
...
def _construir_narrativa(pred, mercado, vb, canal):
    ...
    if tiene_valor:
        ...
        pie_free = (
            ...
            f"🔒 <b>¿Quieres la predicción completa?</b> 👉 https://www.mercadopago.com.co/subscriptions/checkout?preapproval_plan_id=79abf20272b64347b16a901055c89d8c\n\n"
            f"<i>SharpIQ — La ventaja inteligente · sharpiq.co</i>"
        )
        ...
        pie_free = (
            ...
            f"🔒 Predicciones con valor confirmado → https://www.mercadopago.com.co/subscriptions/checkout?preapproval_plan_id=79abf20272b64347b16a901055c89d8c\n\n"
            f"<i>SharpIQ — La ventaja inteligente · sharpiq.co</i>"
        )
        intro_free = ""
